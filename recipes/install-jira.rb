...
# Jira installation-Steps followed from the Jira installation document.
...
directory "node['itwt_jira']['software_dir'].to_s" do
...
directory "node['itwt_jira']['jira_data'].to_s" do
  owner node['itwt_jira']['username']
  group node['itwt_jira']['groupname']
  mode node['itwt_jira']['default_mode']
  recursive true
